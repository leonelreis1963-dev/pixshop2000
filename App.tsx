...
import { generateEditedImage, generateFilteredImage, generateAdjustedImage, generateBackgroundImageRemoved } from './services/geminiService';
...
const App: React.FC = () => {
  ...
  const handleRemoveBackground = useCallback(async () => {
    ...
    try {
        const newImageUrl = await generateBackgroundImageRemoved(currentImage);
            ...
            {activeTab === 'retouch' && (
                <div className="flex flex-col items-center gap-4">
                    <p className="text-md text-gray-400">
                        {editHotspot ? 'Ótimo! Agora descreva sua edição localizada abaixo.' : 'Clique em uma área da imagem para fazer uma edição precisa.'}
                    </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mt-6">
            ...
            <div className="flex-grow sm:flex-grow-0 ml-auto flex gap-2">
                ...
                <button 
                    ...
                    className="bg-gradient-to-br from-teal-600 to-teal-500 text-white font-bold py-3 px-5 rounded-md transition-all duration-300 ease-in-out shadow-lg shadow-teal-500/20 hover:shadow-xl hover:shadow-teal-500/40 hover:-translate-y-px active:scale-95 active:shadow-inner text-base"
                >
                    Baixar JPG
                </button>
            </div>
